...
(
	...
	[Currency] VARCHAR(32) NOT NULL,
	[PriceRate] DECIMAL(24, 12) NOT NULL,
	[Holder] UNIQUEIDENTIFIER NOT NULL
		FOREIGN KEY REFERENCES [Users](ID)
);
...
INSERT INTO [Users](FirstName, LastName, Email, Password) VALUES
	('Vladimir', 'Sivèev', 'vladimirsi@nordeus.com', '191fc174ed9bd33973e55f7b5a948c8b'), -- vladimirsi
	('Radovan', 'Silaški', 'rsilaski@gmail.com', '6e99cd25256d4351f3fb776027e8d271'), -- rsilaski
	('Marko', 'Francuski', 'francmarko@gmail.com', '12f46699c76e0669c77de31a13d77943'), -- francmarko
	('Predrag', 'Mitroviæ', 'pedja1996@gmail.com', 'e04952e2f8d85f604967caf07080bc8c'); -- pedja1996
